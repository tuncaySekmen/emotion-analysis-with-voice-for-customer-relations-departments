...
import os
# webdriver objesi oluşturma
driver = webdriver.Edge()
# youtubeda neşeli,agresif,hüzünlü müzik araması yapma
driver.get("https://www.youtube.com")
indis = 1
muzikcesit=["Neşeli Müzikler", "Agresif Müzikler", "Hüzünlü Müzikler"] 
muzikturleri = [["neşeli müzikler", "emotional songs"],
    ...
    for x in muzikturleri:
        for y in x:
            for i in range(1,5):
                ...
                playlist = driver.find_element(By.XPATH, f"/html/body/ytd-app/div[1]/ytd-page-manager/ytd-search/div[1]/ytd-two-column-search-results-renderer/div/ytd-section-list-renderer/div[2]/ytd-item-section-renderer/div[3]/yt-lockup-view-model[{indis}]")
                driver.execute_script("arguments[0].scrollIntoView(true);", playlist)  # Scroll to the element
                indis=indis+1
                time.sleep(5)
                playlist.click()
                time.sleep(5)  # Sayfanın tamamen yüklenmesini bekleyin
                videon = driver.find_element(By.XPATH, "/html/body/ytd-app/div[1]/ytd-page-manager/ytd-watch-flexy/div[5]/div[2]/div/ytd-playlist-panel-renderer/div/div[1]/div/div[1]/div[1]/div/div/yt-formatted-string/span[3]")
                ...
                for a in range(vsayisi):
                    ...
                    videolinki = driver.find_element(By.XPATH, f"/html/body/ytd-app/div[1]/ytd-page-manager/ytd-watch-flexy/div[5]/div[2]/div/ytd-playlist-panel-renderer/div/div[3]/ytd-playlist-panel-video-renderer[{h}]/a").get_attribute('href')
                    #print(videolinki)
                    yt = YouTube( 
                    str(videolinki)) 
                    # extract only audio 
